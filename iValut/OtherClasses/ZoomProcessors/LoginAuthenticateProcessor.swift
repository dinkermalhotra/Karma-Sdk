...
class LoginAuthenticateProcessor: NSObject, Processor, FaceTecFaceScanProcessorDelegate, URLSessionTaskDelegate {
    var latestNetworkRequest: URLSessionTask!
    var success = false
    var fromViewController: iValtLoginViewController!
    var faceScanResultCallback: FaceTecFaceScanResultCallback!

    init(sessionToken: String, fromViewController: iValtLoginViewController) {
    ...
    func processSessionWhileFaceTecSDKWaits(sessionResult: FaceTecSessionResult, faceScanResultCallback: FaceTecFaceScanResultCallback) {
        ...
        parameters["externalDatabaseRefID"] = "\(Helper.getIntPREF(UserDefaultsConstants.PREF_USERID) ?? 0)"
        ...
        request.addValue(FaceTec.sdk.createFaceTecAPIUserAgentString("\(Helper.getIntPREF(UserDefaultsConstants.PREF_USERID) ?? 0)"), forHTTPHeaderField: "User-Agent")
