struct ViewControllerIdentifiers {
    ...
    static let iValtZoomViewController                      = "iValtZoomViewController"
}
...
class ViewControllerHelper: NSObject {
    ...
    class func getViewController(ofType viewControllerType: ViewControllerType) -> UIViewController {
        ...
        else if viewControllerType == .iValtZoomViewController {
            viewController = storyboard.instantiateViewController(withIdentifier: ViewControllerIdentifiers.iValtZoomViewController) as! iValtZoomViewController
        }
        else {
